...
const EditStaffModal = ({ closeModal, addStaffDetails, updateDetials }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      const response = await updateDetials(_id, {
